package edu.northwestern.ciknow.administration.controller
{
	...
	public class DeriveEdgesByAttributeCommand
	{
		private static var logger:ILogger = LogUtil.getLog(DeriveEdgesByAttributeCommand);
		...
		public function DeriveEdgesByAttributeCommand()
		{
		}
		
		public function execute(event:EdgeEvent):AsyncToken{
			logger.info("Deriving edges by relation...");
			return service.deriveEdgesByAttribute(event.data);
		}
