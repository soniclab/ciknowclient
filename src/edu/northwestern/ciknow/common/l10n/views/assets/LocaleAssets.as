package edu.northwestern.ciknow.common.l10n.views.assets
{
    public class LocaleAssets
    {
				...
				static public function get allFlags():Array {
					return [FLAG_USA, FLAG_FRANCE, FLAG_SPAIN, FLAG_CHINA, FLAG_GERMANY]; 
				}
				...
				[Embed(source='images/flags/china32x32.png')]
				public static const  FLAG_CHINA : Class;

				[Embed(source='images/flags/france32x32.png')]
				public  static const  FLAG_FRANCE : Class;

				[Embed(source='images/flags/spain32x32.png')]
				public static const  FLAG_SPAIN : Class;

				[Embed(source='images/flags/us32x32.png')]
				public static const  FLAG_USA : Class;

				[Embed(source='images/flags/germany32x32.png')]
				 ...
				 * 
				 */
				public static var _locales : Array = [
